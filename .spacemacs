  ...
  (setq-default
   ...
   '(;; ----------------------------------------------------------------
     ...
     (neotree :variables
              ...
              neo-theme 'icons
              neo-hidden-regexp-list '("^\\." "\\.pyc$" "~$" "^#.*#$" "\\.elc$" "\\.o$" "\\.vo$" "\\.glob$" "\\.vok$" "\\.vos$" "^Makefile.coq$" "^Makefile.coq.conf$" "\\.aux$" "\\.bbl$" "\\.bcf$" "\\.blg$" "\\.run.xml$" "\\.fls$" "\\.tdo$" "\\.log$" "\\.out$" "\\.synctex.gz$" "\\.fdb_latexmk$" "^dist-newstyle$" "^\\.stack-work$")
              neo-autorefresh t
              neo-smart-open t)
     (shell :variables
...
" t)))
  ...
  (with-eval-after-load 'org
    (setq org-tag-faces '(("arzamas" . "Gray")
                          ...
                          ("grammar" . "magenta3")
                          ("health" . "Chartreuse")
                          ("interest" . "MediumSpringGreen")
                          ("issue" . "red")
                          ("job" . "DarkOrange")
                          ("learn" . "MediumSpringGreen")
                          ("listening" . "green4")
                          ("meta" . "Violet")
                          ...
                          ("stuff" . "Gray")
                          ("contrib" . "Gold")
                          ("event" . "MediumSpringGreen")
                          ("present" . "Red2")
                          ("advise" . "DodgerBlue")
                          ("read" . "White")
                          ("watch" . "White")
                          ("teach" . "MediumSpringGreen")
                          ("social" . "DeepSkyBlue")
                          ("todo" . "orange2")
                          ("toread" . "orange2")
                          ("toreread" . "orange2")
    ...
    (setq  org-todo-keyword-faces '(("ABORT" . "#8c5353")
                                    ("ACTIVE" . "red1")
                                    ("ASK" . "DarkOrchid")
                                    ("CLEAR" . "green")
                                    ("COLLECTION" . "#0098DD")
    ...
    (setq org-link-elisp-confirm-function #'my-org-link-elisp-confirm-function)

    (global-set-key (kbd "M-m a o d") 'org-update-all-dblocks)
    (global-set-key (kbd "M-m a o C u") 'org-clock-update-time-maybe)
    ;; (global-set-key (kbd "M-m a o C p") 'org-clock-in-past) TODO: move here all custom binding (and move functions out)
